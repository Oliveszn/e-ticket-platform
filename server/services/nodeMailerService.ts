...
const MailingService = {
  ...
  async sendWithNodemailer(
    ...
    try {
      const mailOptions = {
        from: '"StagePass" <ekpealamicheal@gmail.com>',
      ...
      logger.warn("Nodemailer Response:", info);

      return { messageId: info.messageId, provider: "nodemailer" };
    } catch (error) {
      logger.error("Nodemailer send failed:", error);
      throw error;
    }
  },
  ...
  // individual ticket email (to each recipient)
  ...
  async sendPromoterWelcome(promoterData: PromoterData) {
    ...
    return await this.sendEmail({
      to: email,
      subject: `Welcome to StagePass, ${firstName} - Start Selling Today!`,
      html,
      text,
    });
  },
   ...
   <!DOCTYPE html>
    ...
    <body>
      <div class="container">
        ...
        <div class="footer">
          <p>Need help? Contact us at support@stagepass.com</p>
        </div>
      </div>
    </body>
    </html>`;
    ...
    <body>
      <div class="container">
        ...
        <div class="footer">
          ...
          <p>Need help? Contact support@stagepass.com</p>
        </div>
      </div>
    </body>
    </html>`;
  ...
  <body>
    <div class="container">
      ...
      <div class="footer">
        <p>Need help? Contact us at support@stagepass.com</p>
        <p>© 2024 StagePass. All rights reserved.</p>
      </div>
    </div>
  </body>
  </html>`;
...
Need help? Contact us at support@stagepass.com
    `;
  },
